...
public class MyReadXML {
    String INFOTEXT="Here you can see all the paths between 'void OnClicks' and sinks. For each path\n" +
            ...
            "assigns a number to each path and each method.\n";
    public void readAndParseXML() {
        ...
        String apkfn =  ".\\results\\"+ ArgsParserMSC.file+"_results_my.xml";
        ...
        try {
            ...
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    //temp +1 is the path number , the getLength gives the number of methodEntries
                    int numberOfMEs= eElement.getElementsByTagName("methodEntry").getLength();
                    if (numberOfMEs!=0) {
                        WriteResult(apkfn, "\nNumber of of MethodEntries in Path.No   " + (temp + 1) +
                                "  is   " + numberOfMEs + ":");
                        ...
                        /*Just for determining if it has any Show()*/
                            ...
                            WriteResult(apkfn, "\nSignature of Method Entry No.  " + (i + 1) + "   is " + result
